...
const EditResultadoExameScreen = ({
  navigation,
  route,
}: Props) => {
  ...
  const handleSave = async () => {
    try {
      ...
      await fetch(
        `http://127.0.0.1:8000/resultadoexame/api/${resultado.id}/`,
        {
          method: 'PUT',
          headers: {
            'Content-Type':
...
export default EditResultadoExameScreen;